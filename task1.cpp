...
int main () {
    ...
    cout << "_______________________" << endl;
    int arr5[] = {961, 628, 74, 865, 532, 947, 291, 264, 739, 113, 228, 739, 192, 591, 104, 836, 102, 529, 87, 370, 875, 102, 300, 398, 838, 573, 717, 165, 816, 192, 893, 280, 277, 879, 7, 465, 97, 277, 95, 979, 791, 418, 759, 374, 203, 209, 418, 534, 499, 888, 726, 372, 279, 176, 766, 889, 548, 587, 755, 58, 525, 282, 975, 747, 88, 923, 297, 120, 423, 67, 62, 362, 469, 672, 219, 756, 340, 664, 223, 901, 475, 214, 631, 629, 763, 499, 207, 629, 626, 354, 850, 387, 528, 188, 395, 50, 299, 7, 303, 353};
    int cubic5 = cubic_mss(arr5, sizeof(arr5));
    cout << "Cubic Solution:  " << cubic5 << endl;
    int quad5 = quad_mss(arr5, sizeof(arr5));
    cout << "Quadratic Solution:  " << quad5 << endl;
    int lin5 = lin_mss(arr5, sizeof(arr5));
    cout << "Linear Solution:  " << lin5 << endl;
    cout << "_______________________" << endl;
